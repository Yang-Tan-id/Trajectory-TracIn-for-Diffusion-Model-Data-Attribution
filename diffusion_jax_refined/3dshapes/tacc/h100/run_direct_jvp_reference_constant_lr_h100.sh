#!/usr/bin/env bash
#SBATCH -J 3d-djvp-ref-h100
#SBATCH -o 3d-djvp-ref-h100-%j.out
#SBATCH -e 3d-djvp-ref-h100-%j.err
#SBATCH -p h100
#SBATCH -N 4
#SBATCH -n 16
...
echo "[definition] direct JVP; reference trajectory; 10 timestamps; constant checkpoint weights; projection=4096"
...
for shard in $(seq 0 15); do
  ...
  ) >"direct-jvp-reference-h100-gpu-${shard}-${SLURM_JOB_ID}.log" 2>&1 &
  pids+=("$!")
done
