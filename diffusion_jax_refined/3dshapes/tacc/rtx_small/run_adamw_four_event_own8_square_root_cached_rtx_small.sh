#!/usr/bin/env bash
#SBATCH -J 3d-adam4-o8
#SBATCH -o 3d-adam4-o8-%j.out
#SBATCH -e 3d-adam4-o8-%j.err
#SBATCH -p rtx-small
#SBATCH -N 1
#SBATCH -n 2
...
log_root="$shapes/result/$exp/logs/adamw_four_event_own8/${SLURM_JOB_ID}"
mkdir -p "$log_root"
...
echo "[done] AdamW four-event cached own8 square/root LDS"
