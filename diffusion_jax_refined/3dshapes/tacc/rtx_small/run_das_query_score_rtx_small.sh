#!/usr/bin/env bash
#SBATCH -J 3d-das-query
#SBATCH -o 3d-das-query-%j.out
#SBATCH -e 3d-das-query-%j.err
#SBATCH -p rtx-small
#SBATCH -N 1
#SBATCH -n 2
...
REPO_ROOT="$(resolve_repo_root)" || {
  echo "Could not locate the 3D Shapes DAS query/score driver" >&2
  exit 1
}
...
echo "3D Shapes DAS query gradients + 16-lambda batched score"
echo "GPU 0/1 split queries, then split lambda values; train/Gram artifacts are reused"
nvidia-smi
