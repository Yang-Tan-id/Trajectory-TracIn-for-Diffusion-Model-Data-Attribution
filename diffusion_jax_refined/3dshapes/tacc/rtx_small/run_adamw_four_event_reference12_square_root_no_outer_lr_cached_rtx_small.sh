#!/usr/bin/env bash
#SBATCH -J 3d-adam4-p12n
#SBATCH -o 3d-adam4-p12n-%j.out
#SBATCH -e 3d-adam4-p12n-%j.err
#SBATCH -p rtx-small
#SBATCH -N 1
#SBATCH -n 2
...
echo "[done] AdamW four-event reference12 square/root without outer checkpoint LR"
