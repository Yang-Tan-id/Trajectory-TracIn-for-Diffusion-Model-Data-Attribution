#!/usr/bin/env bash
#SBATCH -J 3d-pn12-ckptlds
#SBATCH -o 3d-pn12-ckptlds-%j.out
#SBATCH -e 3d-pn12-ckptlds-%j.err
#SBATCH -p rtx-small
#SBATCH -N 1
#SBATCH -n 2
...
LOG_ROOT="${SHAPES_ROOT}/result/${EXPERIMENT_TAG}/logs/predicted_noise_probe12_per_checkpoint_lds/${SLURM_JOB_ID}"
mkdir -p "${LOG_ROOT}"

echo "[phase 1/2] retain all 50 independent checkpoint score contributions for 12 probes"
pids=()
for shard in 0 1; do
  (
...
echo "[done] Probe12 per-checkpoint LDS analysis complete"
