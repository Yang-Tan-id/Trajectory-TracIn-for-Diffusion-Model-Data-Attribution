#!/usr/bin/env bash
#SBATCH -J 3d-pn9-12-q
#SBATCH -o 3d-pn9-12-q-%j.out
#SBATCH -e 3d-pn9-12-q-%j.err
#SBATCH -p rtx-small
#SBATCH -N 1
#SBATCH -n 2
...
echo "[phase 1/1] ensure independent predicted-noise probes 9-12"
for probe_index in 8 9 10 11; do
  ...
  "${PYTHON_BIN}" "${QUERY_DRIVER}" \
    ...
    --num-snapshots 10 --log-prefix "probe_${probe_index}" --python-bin "${PYTHON_BIN}"
done
echo "[done] independent probes 9-12 are complete"
