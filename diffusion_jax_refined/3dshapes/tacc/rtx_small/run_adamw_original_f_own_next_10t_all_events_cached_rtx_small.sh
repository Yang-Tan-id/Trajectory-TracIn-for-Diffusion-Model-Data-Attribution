#!/usr/bin/env bash
#SBATCH -J 3d-own10-e14
#SBATCH -o 3d-own10-e14-%j.out
#SBATCH -e 3d-own10-e14-%j.err
#SBATCH -p rtx-small
#SBATCH -N 1
#SBATCH -n 1
...
out_root="$shapes/result/$experiment/eval/adamw_four_event_original_f_own_next_10t_all_events/run_${SLURM_JOB_ID}"
mkdir -p "$out_root/linear" "$out_root/squared"

echo "[cached query] own trajectory, raw next-checkpoint direction, 10 timestamps"
...
echo "[done] cached own10 E1-E4/FOUR linear and squared LDS: $out_root"
