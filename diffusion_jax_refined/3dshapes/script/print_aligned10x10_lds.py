...
SCHEME_GROUPS = {
    ...
    "previous_target_last_checkpoint_raw_unit": (
        (
            "raw_previous_target_last_checkpoint_squared_unit_weight",
    ...
    "query_timestamp_shared_termwise_squared": (
        (
            "residual_query_timestamp_shared_termwise_squared",
            "traj_tracin_adamw_residual_aligned10x10_query_timestamp_shared_termwise_squared",
        ),
        (
            "full_query_timestamp_shared_termwise_squared",
