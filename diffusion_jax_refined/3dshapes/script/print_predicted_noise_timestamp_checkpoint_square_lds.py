...
def main() -> None:
    ...
    namespace_bases = {
        ...
        "probe_l2": "traj_tracin_predicted_noise_jvp_probe_l2",
        "timestamp_probe_l2": "traj_tracin_predicted_noise_jvp_timestamp_probe_l2",
    ...
    titles = {
        ...
        "probe_l2": "PER-TERM PROBE L2 sqrt(sum_r(z_r^2))",
        "timestamp_probe_l2": "PER-TIMESTAMP ROOT sqrt(sum_c w_c sum_r(z_r^2))",
