#!/usr/bin/env bash
#SBATCH -J x3-s3-das-lds
#SBATCH -o x3-s3-das-lds-%j.out
#SBATCH -e x3-s3-das-lds-%j.err
#SBATCH -p h100
#SBATCH -N 4
#SBATCH -n 16
...
LOG_ROOT="${X3_ROOT}/result/${EXPERIMENT_TAG}/stampede3_das_logs/01_train_lds_models/${SLURM_JOB_ID:-local}"
mkdir -p "${LOG_ROOT}"
