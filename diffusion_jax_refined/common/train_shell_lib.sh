...
train_run_prompted_solo() {
  ...
  "${PYTHON_BIN:-python}" "${dataset_root}/../common/prompted_jax_training.py" "${dataset_root}/dataset_config.py" --algorithm "${ALGORITHM:-shared}"
}
...
train_run_unprompted_solo() {
  ...
  "${PYTHON_BIN:-python}" "${dataset_root}/../common/prompted_jax_training.py" "${dataset_root}/dataset_config.py" --algorithm "${ALGORITHM:-shared}" --unconditional
}
