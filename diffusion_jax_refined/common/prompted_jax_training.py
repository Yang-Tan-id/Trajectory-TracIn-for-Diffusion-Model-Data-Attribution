...
def run_prompted_cifar_training(
    ...
    *,
    ...
    train_cfg = train_mod.TrainConfig(
        ...
        learning_rate=_optional_float("JAX_LEARNING_RATE", 1e-4),
        lr_schedule=os.environ.get("JAX_LR_SCHEDULE", "cosine_warmup"),
        lr_warmup_ratio=_optional_float("JAX_LR_WARMUP_RATIO", 0.1),
...
def run_prompted_artbench_training(
    ...
    *,
    ...
    train_cfg = train_mod.LatentArtBenchConfig(
        ...
        dm_learning_rate=_optional_float("JAX_LEARNING_RATE", 1e-4),
