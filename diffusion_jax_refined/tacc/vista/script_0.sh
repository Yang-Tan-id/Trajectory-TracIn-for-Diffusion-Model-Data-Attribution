...
echo "vista script_0: dataset=${DATASET}, train_modes=${TRAIN_MODES}, gpus=${CUDA_VISIBLE_DEVICES}, experiment=${EXPERIMENT_TAG:-experiment1}"
exec bash "${REFINE_ROOT}/${DATASET}/scripts/script_0.sh" ${TRAIN_MODES//,/ }
