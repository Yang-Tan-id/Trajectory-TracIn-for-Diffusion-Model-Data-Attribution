...
echo "h100 datapoint gradients: dataset=${DATASET}, algorithms=${ALGORITHMS}, train_modes=${TRAIN_MODES:-${TRAIN_MODE:-none}}, gradient_modes=${DATAPOINT_GRADIENT_MODES:-${GRADIENT_MODES:-prompted}}, gpus=${CUDA_VISIBLE_DEVICES}"
