...
def traj_query_expected_terms() -> int:
    ...
    next_checkpoint_objectives = (
        ...
        "next_checkpoint_implied_noise_mse",
        "next_ckpt_implied_noise_mse",
        "trajectory_targeted_implied_noise_mse",
        "trajectory_next_checkpoint_trajectory_noise_mse",
        "next_checkpoint_trajectory_noise_mse",
        "next_ckpt_trajectory_noise_mse",
        "next_trajectory_reference_noise_mse",
