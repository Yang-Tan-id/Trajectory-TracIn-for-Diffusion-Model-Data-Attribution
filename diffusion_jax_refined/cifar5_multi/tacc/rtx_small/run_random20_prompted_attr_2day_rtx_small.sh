...
echo "traj_query_objective=${TRAJ_QUERY_OBJECTIVE:-trajectory_next_checkpoint_noise_mse}"
echo "traj_parameter_source=${TRAJ_PARAMETER_SOURCE:-${TRACIN_PARAMETER_SOURCE:-ema}}"
