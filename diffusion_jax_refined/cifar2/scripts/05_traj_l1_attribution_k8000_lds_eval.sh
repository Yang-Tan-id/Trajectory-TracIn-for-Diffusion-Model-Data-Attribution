...
# One-command CIFAR2 local/server workflow:
#   1) sample the three CIFAR2 query prompts with the requested initial seed;
...
TRAJ_RANGES_TEXT="${TRAJ_RANGES_TEXT:-1-2000 2001-4000 4001-6000 6001-8000 8001-10000}"
...
echo "CIFAR2 traj L1 attribution + k=${LDS_K} LDS eval"
echo "ROOT=${ROOT}"
