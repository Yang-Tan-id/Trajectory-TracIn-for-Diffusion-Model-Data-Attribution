...
echo "experiment=${EXPERIMENT_TAG}; train_seed=${TRAIN_SEED}; sample_mode=${SMOKE_SAMPLE_MODE}; score_mode=${SMOKE_SCORE_MODE}; query=${SMOKE_QUERY}; seed=${SMOKE_INITIAL_SEED}; lambdas=${DAS_DAMPING_SWEEP_VALUES}"
echo "logs=${LOG_ROOT}"
