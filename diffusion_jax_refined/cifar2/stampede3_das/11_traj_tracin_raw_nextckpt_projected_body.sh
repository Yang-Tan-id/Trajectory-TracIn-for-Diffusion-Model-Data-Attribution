...
TRAJ_NUM_SNAPSHOTS="${TRAJ_NUM_SNAPSHOTS:-10}"
TRAJ_TRAIN_MC_SAMPLES="${TRAJ_TRAIN_MC_SAMPLES:-10}"
TRAJ_SNAPSHOT_POSITIONS="${TRAJ_SNAPSHOT_POSITIONS:-}"
...
TRAJ_TRACIN_TRAIN_AGGREGATE_TIMESTAMPS="${TRAJ_TRACIN_TRAIN_AGGREGATE_TIMESTAMPS:-0}"
...
run_one_task() {
  ...
  run_gpu_slot "${slot}" env \
    ...
    TRAJ_NUM_SNAPSHOTS="${TRAJ_NUM_SNAPSHOTS}" \
    TRAJ_TRAIN_MC_SAMPLES="${TRAJ_TRAIN_MC_SAMPLES}" \
    TRAJ_SNAPSHOT_POSITIONS="${TRAJ_SNAPSHOT_POSITIONS}" \
