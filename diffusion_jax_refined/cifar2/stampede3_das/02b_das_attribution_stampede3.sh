#!/usr/bin/env bash
#SBATCH -J cifar2-s3-das-attr-b
#SBATCH -o cifar2-s3-das-attr-b-%j.out
#SBATCH -e cifar2-s3-das-attr-b-%j.err
#SBATCH -p h100
#SBATCH -N 4
#SBATCH -n 16
...
export STAMPEDE3_DAS_DIR="${SCRIPT_DIR}" ATTR_JOB_INDEX=1 ATTR_NUM_JOBS=3 ATTR_CHUNK_SIZE=16
