...
ARTIFACT_BASE="${PROJECTED_ARTIFACT_BASE:-${CIFAR2_ROOT}/result/${EXPERIMENT_TAG}/projected_traj_tracin_artifacts/${ATTRIBUTION_SCORE_MODEL_MODE}/train_seed_${TRAIN_SEED}}"
