...
SUBSET_SIZE = int(N_TRAIN * SUBSET_FRACTION)  # 12500 for N_TRAIN=50000
...
# ============================================================
# Query bank: 100 independently sampled queries (75 prompted + 25 unprompted)
# ============================================================
INITIAL_SEEDS = tuple(range(100))
PROMPTED_INITIAL_SEEDS = tuple(range(75))
UNPROMPTED_INITIAL_SEEDS = tuple(range(75, 100))
RANDOM_PROMPTS_PER_PROMPTED_INITIAL = 1  # 75*1 + 25 = 100
...
# Attribution
# ============================================================
TRACIN_PARAM_SOURCES = ("raw", "ema")
# Backward-compatible default for the optional query-gradient cache script.
TRACIN_PARAM_SOURCE = "raw"
TRACIN_TRAIN_MC = 10
TRACIN_PROJ_DIM = 4096
TRACIN_PROJECTED_BATCH_SIZE = 16
TRACIN_SECOND_ORDER_COEFFICIENT = 0.5
TRACIN_CONTRACTIONS = (
    "linear",
...
DAS_PARAM_SOURCE = "ema"  # backward compatibility
DAS_PARAM_SOURCES = ("ema", "raw")
DAS_PROJ_DIM = 4096
DAS_FEATURE_BATCH_SIZE = 8
DAS_FAST_VMAP = True
DAS_TIMESTEPS = tuple(int(i * (T - 1) / 99) for i in range(100))
DAS_NUM_MC = 10
DAS_TRAIN_GRAD_MC = 10
